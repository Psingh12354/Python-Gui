...
var1=IntVar()
Checkbutton(root,text="Java",variable=var1).place(x=235,y=340)
var2=IntVar()
Checkbutton(root,text="Python",variable=var2).place(x=290,y=340)
var3=IntVar()
Checkbutton(root,text="Java",variable=var3).place(x=360,y=340)
Button(root,text="Submit",width=24,bg="gray",fg="white").place(x=200,y=380)
mainloop()